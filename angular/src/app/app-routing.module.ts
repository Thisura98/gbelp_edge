...
const routes: Routes = [
  ...
  {path: "groups/sessions/create/:groupId", component: GroupSessionCreateComponent, data: { editMode: false }},
  {path: "groups/sessions/edit/:sessionId", component: GroupSessionCreateComponent, data: { editMode: true }},
