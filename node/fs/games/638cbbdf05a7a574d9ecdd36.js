...
class CommonLevel extends Phaser.Scene{
    ...
    constructor(object){
        ...
        this.kGuiNoPoints10Seconds = 'No points for 10 seconds';
        this.kGuiNoPoints30Seconds = 'No points for 30 seconds';
    ...
    updatePoints(newPoints){
        if (newPoints != null){
            ...
            if ((this.time.now / 1000) <= 5){
                EdgeProxy.increaseObjectiveProgress(this.kObj5Points12Seconds, newPoints - lastPoints);
            }
    ...
    setupGuidanceTriggers(){
        ...
        const config1 = {
            ...
            callback: () => { 
                if (this.points <= 0){
                    EdgeProxy.increaseGuidanceProgress(this.kGuiNoPoints10Seconds, 1);
                }
            }
        };
        ...
        const config2 = {
            ...
            callback: () => { 
                if (this.points <= 0){
                    EdgeProxy.increaseGuidanceProgress(this.kGuiNoPoints30Seconds, 1);
                }
            }
        };
