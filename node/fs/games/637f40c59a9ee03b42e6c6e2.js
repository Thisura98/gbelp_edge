...
class LevelScene_Title_Screen extends Phaser.Scene{
    ...
    preload(){
		...
		this.load.image('coin', 'fs/res_upload/image/44346069-e228-4786-ba6f-b86be4c62328.png');
		this.load.image('coin_png_2', 'fs/res_upload/image/44346069-e228-4786-ba6f-b86be4c62328.png');
        this.levelData = {
    "objects": [
        {
