...
class LevelScene_Level1 extends Phaser.Scene{
    ...
    preload(){
		...
		this.load.image('bullet', 'fs/res_upload/image/7363f872-1f5b-4c14-81c6-f9d91eccdd74.png');
		this.load.image('meteor', 'fs/res_upload/image/3837edeb-a9d4-43dc-b438-e0c3dedd0234.png');
		this.load.image('panel', 'fs/res_upload/image/6a853da3-ed38-4f81-97ec-61faa7df245e.png');
