...
class LevelScene_Title_Screen extends Phaser.Scene{
    ...
    preload(){
		...
		this.load.image('sprite_png', 'fs/res_upload/image/1657909493556.png');
    }
    create(){
        let scaleX = 0, scaleY = 0;
		// --- scene object sprite_png ---
		const sprite_1 = this.add.sprite(139.0587714758443, 124.00842110370178, 'sprite_png');
		sprite_1.name = "sprite_png";
...
const scenes = [LevelScene_Title_Screen, LevelScene_Example_Level_Screen, LevelScene_New_Level, LevelScene_Game_Over_Screen];
const gameZoom = 1.5;
