...
--
-- Host: mysqlhost
-- Generation Time: Jul 12, 2021 at 06:56 PM
...
CREATE TABLE `game_entry` (
  ...
  `project_id` tinyint(1) NOT NULL COMMENT 'MongoDB Document ID',
...
INSERT INTO `game_objective` (`objective_id`, `name`, `max_value`) VALUES
(1, 'Survive without losing 100% health', 0),
(2, 'Destroy 10 asteroids', 10),
(3, 'Destroy 3 enemies', 3),
(4, 'Flight Navigator', 1000);
...
(54, 1, 'd60dd6fe-fc05-4bb9-b11d-d76c6c3ca68b', '2021-07-13 01:36:44');
...
--
ALTER TABLE `user_auth`
  MODIFY `auth_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
