...
(134, 1, '7dc9b970-824e-4688-89f5-a450fcf6c6d5', '2021-09-08 03:38:44');
...
--
ALTER TABLE `gsessions`
  MODIFY `session_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `user_auth`
  MODIFY `auth_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
